...
final Map<String, ThemeData> themesList = {
  ...
  'purple': ThemeData(
    scaffoldBackgroundColor: const Color.fromARGB(255, 89, 67, 148),
    primaryColor: const Color.fromARGB(255, 159, 106, 250),
    ...
    splashColor: const Color.fromARGB(255, 159, 106, 250),
    focusColor: const Color.fromARGB(255, 89, 67, 148),
  ),
  'peach pink': ThemeData(
    ...
    splashColor: const Color.fromRGBO(255, 171, 171, 1),
    focusColor: Color.fromARGB(255, 216, 146, 146),
  ),
};
